const { buildDateTime, buildDate, DATE_TIME_FORMAT_SPEC } = require('./dateHelpers')

describe('Date helpers', () => {
  describe('buildDateTime', () => {
    it('should return a valid date time with 0 as hours and minutes', () => {
      const dateTime = buildDateTime({ date: '20/10/2012', hours: 0, minutes: 0 })
    ...
    it('should return a valid date time with strings as params ', () => {
      const dateTime = buildDateTime({ date: '20/10/2012', hours: '00', minutes: '00' })
      expect(dateTime.format(DATE_TIME_FORMAT_SPEC)).toEqual('2012-10-20T00:00:00')
    })

    it('should handle empty string', () => {
      const dateTime = buildDateTime({ date: '20/10/2012', hours: '', minutes: '' })
